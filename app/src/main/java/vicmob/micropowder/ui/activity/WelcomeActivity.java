...
import vicmob.micropowder.service.GetDataService;
...
public class WelcomeActivity extends Activity implements LoadData {
        ...
        mHandle.postDelayed(new Runnable() {
            ...
            public void run() {
                if (count == 0) {
                    ...
                    int permission = ContextCompat.checkSelfPermission(WelcomeActivity.this, Manifest.permission.READ_PHONE_STATE);
                    ...
                    if (permission != PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(WelcomeActivity.this, new String[]{Manifest.permission.READ_PHONE_STATE,
                                ...
                                Manifest.permission.MOUNT_FORMAT_FILESYSTEMS}, 0x0010);
                    } else {
                        startService(new Intent(WelcomeActivity.this, GetDataService.class));
                        startAndFinishThis();
                    }
