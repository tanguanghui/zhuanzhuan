...
public class WxAutoReplyService extends AccessibilityService {
    ...
    public void onAccessibilityEvent(final AccessibilityEvent event) {
        ...
        //查询数据
        AutoReplyDao mAutoReplyDao = new AutoReplyDao(WxAutoReplyService.this);
    ...
    private boolean findEditText(AccessibilityNodeInfo rootNode, String content) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (nodeInfo == null) {
                Log.d("222maptrix", "nodeinfo = null");
                continue;
            }
            Log.d("226maptrix", "class=" + nodeInfo.getClassName());
            Log.e("227maptrix", "ds=" + nodeInfo.getContentDescription());
            if (nodeInfo.getContentDescription() != null) {
                ...
                Log.e("232maptrix", "nindex=" + nindex + " cindex=" + cindex);
                if (nindex != -1) {
                    itemNodeinfo = nodeInfo;
                    Log.i("235maptrix", "find node info");
                }
            }
