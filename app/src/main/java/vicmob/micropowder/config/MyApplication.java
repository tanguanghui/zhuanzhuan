...
import vicmob.micropowder.daoman.bean.DefaultDataBean;
import vicmob.micropowder.daoman.bean.LoadLocationBean;
import vicmob.micropowder.daoman.bean.LoadWhiteBean;
import vicmob.micropowder.daoman.bean.MainDeviceBean;
...
public class MyApplication extends Application {
     ...
     * 自动选择回复
     */
    private boolean AutoSelectReply = false;
    /**
     * 白名单模块
     */
    ...
    public boolean getSelectReply() {
        return AutoSelectReply;
    }

    public void setSelectReply(boolean autoSelectReply) {
        AutoSelectReply = autoSelectReply;
    }

    public boolean getAllowSelectReply() {
        return AllowAddFriends;
    }

    public void setAllowSelectReply(boolean allowAddFriends) {
        AllowAddFriends = allowAddFriends;
    }
