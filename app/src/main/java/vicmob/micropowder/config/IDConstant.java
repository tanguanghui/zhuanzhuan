...
/**
 * Created by Eren on 2017/6/26.
 * <p/>
 * ID节点配置
 */
public class IDConstant {
    /**
     * 微信聊天的list item 中的控件的id ;  id不变， content of text will change ;
     * 包名：com.tencent.mm
     */
    //com.tencent.mm.ui.mogic.WxViewPager
    public static final String Wx_CHAT_LIST = "aoh";
    public static final String Wx_CHAT_TITLE = "aoj";
    public static final String Wx_CHAT_CONTENT = "aol";

    /**
     * 微信聊天的list item 中未读的消息条数的id 是io
     */
    public static final String Wx_CHAT_NUM = "io";
    /**
     * 微信聊天的编辑输入框；
     */
    public static final String Wx_SelectChat_Edit_Text = "aaf";
    /**
     * 微信标题文本控件 ：腾讯新闻或订阅号 ， id 是text1；
     */
    public static final String Wx_Head_Title = "text1";
    /**
     * 微信标题栏中的搜索控件 ， id 无  text 内容无 ，content-decs:搜索 ；
     */
    public static final String Wx_SearchContent_Decs = "搜索";
    /**
     * 微信标题栏中的搜索输入框 ， id ：he  text 内容无 ，content-decs:搜索 ；
     * 微信测试版 搜索输入框的id：hk;
     */
//    public static final String Wx_Search_EditText = "he";
    public static final String Wx_Search_EditText = "hk";
    /**
     * 微信标题栏中的搜索输入框 下面的联系人中的微信号的id ：pf；
     */
//    public static final String Wx_Contact_NickName = "k1";
    public static final String Wx_Contact_NickName = "kh";
    public static final String Wx_Contact_Id = "pf";
//    public static final String Wx_Search_Back = "hb";
    public static final String Wx_Search_Back = "hh";

    /**
     * 主界面四个功能按钮
     */
//    public static final String MAIN_BUTTON = "c2z";
    public static final String MAIN_BUTTON = "c3c";
    //微信按钮上的未读消息提示
    public static final String Wx_UnReadNum = "c3d";
    /**
     * 返回
     */
     ...
     *添加图标的id
     */
    public static final String Wx_Add = "fx";
...
//    public static final String WX_CHATTING_BACK = "h4";
    ...
    public static final String WX_News_BACK = "hj";
